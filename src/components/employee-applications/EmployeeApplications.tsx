...
export function EmployeeApplications() {
  ...
  const filteredApplications = mockEmployeeApplications.filter(
    (application) => {
      const matchesSearch =
        searchQuery === "" ||
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-card border border-border rounded-lg p-4 text-center">
          <div className="text-2xl font-bold text-foreground">
            {mockEmployeeApplications.length}
          </div>
        ...
        <div className="bg-card border border-border rounded-lg p-4 text-center">
          <div className="text-2xl font-bold text-warning">
            {
              mockEmployeeApplications.filter((a) => a.status === "pending")
                .length
            }
          </div>
        ...
        <div className="bg-card border border-border rounded-lg p-4 text-center">
          <div className="text-2xl font-bold text-success">
            {
              mockEmployeeApplications.filter((a) => a.status === "approved")
                .length
            }
          </div>
        ...
        <div className="bg-card border border-border rounded-lg p-4 text-center">
          <div className="text-2xl font-bold text-destructive">
            {
              mockEmployeeApplications.filter((a) => a.status === "rejected")
                .length
            }
          </div>
